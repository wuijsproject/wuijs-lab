...
This demo shows the use of WUILoader's basic functionality.
...
- [WUILoader](https://github.com/wui-js/wuijs-main-lib/blob/main/docs/README-en.md#wui-loader): `WUILoader` component documentation.
